    ...
    <View style={{ position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, zIndex: 50 }}>
      ...
      >
        <SafeAreaView
          edges={['bottom']}
          style={{
            backgroundColor: Colors[scheme].backgroundSoft,
        ...
        >
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12, marginBottom: 16 }}>
            <View
              style={{ width: 56, height: 56, borderRadius: 28, overflow: 'hidden', borderWidth: 2, borderColor: tint }}
            >
              ...
              <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 4 }}>
                {Array.from({ length: 5 }).map((_, i) => (
                  <FontAwesome
                    ...
                    name="star"
                    size={12}
                    color={i < Math.floor(driver.rating) ? Palette.amber500 : Palette.gray600}
                    style={{ marginRight: 2 }}
                  />
                ))}
                <Text style={{ marginLeft: 6, color: Colors[scheme].mutedText, fontSize: 12 }}>
          ...
          <Pressable
            onPress={onClose}
            accessibilityRole="button"
            accessibilityLabel="Close driver sheet"
            hitSlop={10}
          ...
          >
            <Text style={{ color: Palette.destructive, fontWeight: '600' }}>Close</Text>
          </Pressable>
        </SafeAreaView>
      </Animated.View>
    </View>
